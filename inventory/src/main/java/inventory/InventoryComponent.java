 ...
 *
 */
@Component(name = "azadlife-inventory-comp", immediate = true)
public class InventoryComponent {
	...
	public void activate(ComponentContext componentContext) throws Exception {
		...
		osgiDefaultCamelContext.setName("azzad-inventory");
...
//		dataSource.setPassword("asanlife_#");
		...
		camelContext.getRegistry().bind("azadInventory", dataSource);
