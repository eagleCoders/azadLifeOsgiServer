package infrastructure.core.data;
...
public class DataValidatorBuilder {
	 ...
	 *
	 * @param dataValidationErrors an existing list of {@link ApiParameterError} to
	 *                             add new validation errors to
	 */
	...
	/*
	 * This method is not meant for validation, if you have mandatory boolean param
	 * and if it has invalid value or value not passed then call this method, this
	 * method is always used with input as false
	 */
