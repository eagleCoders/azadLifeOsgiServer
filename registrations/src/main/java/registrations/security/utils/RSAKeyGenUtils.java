...
public class RSAKeyGenUtils {
	...
	public static PGPKeyRingGenerator generateKeyRingGenerator(String id, char[] passPharase, int s2kcount)
			throws Exception {
		...
		PBESecretKeyEncryptor pske = bcPBESecretKeyEncryptorBuilder.build(passPharase);
		
//		PBESecretKeyEncryptor pske = (new BcPBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256, sha256Calc,
//				s2kcount)).build(passPharase);
